<template>
  <section>
    <p><b>src:</b> ссылка на изображение (путь к jpg, png, svg файлу для тега img).</p>
    <p>Увеличение изображения до 200% или занятия всего размера экрана. Уменьшение до 50%.</p>
